...
void printdata(string[], string[], char[], int[], float[],  float[], float[], float[], float[], float[], float[], int);
...
int main() {
    ...
    printdata(firstname, lastname, status, id, hours, ot_hours, rate, ot_rate, grosspay, taxrate, netpay, n);
...
// print data table
void printdata(string firstname[], string lastname[], char status[], int id[], float hours[],  float ot_hours[], float rate[], float ot_rate[], float grosspay[], float taxrate[], float netpay[], int n){
    // print table header
